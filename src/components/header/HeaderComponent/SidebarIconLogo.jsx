...
function SidebarIconLogo({ darkMode, logoImagesSetting, onClickLogoImagesSetting, }) {

  const sharedClassLogo = `w-full flex items-center gap-5 border p-3 rounded-lg cursor-pointer ${darkMode ? "text-[#fff] border-[#5d5d5d] rounded-lg"  : "text-[#343a40] border-[#22a5ad]"}`

  const sharedClassBtn = `w-full flex items-center gap-5 cursor-pointer`

  return (
    <>

      <div className={`sidebarLogoSetting z-10 flex-wrap content-start gap-[50px] w-full sm:w-[350px] fixed right-0 top-0 h-screen border ${darkMode ? "bg-[#000] border-[#666]" : "bg-[#fff] border-[#DDD]"} ${logoImagesSetting ? "flex" : "hidden"}`}>
        
      <div className={`logoImagesSettingLogo flex items-center justify-between h-fit w-full border-b px-3 py-[14px] ${darkMode ? "border-[#5d5d5d]" : "border-[#ddd] "} `}>

          <div className="logoImage">
            <Link to={`/`}>
              <button className={`w-full flex items-center gap-5 cursor-pointer`}
                onClick={() => onClickLogoImagesSetting()}
              >
                <svg
                  width="118"
                  height="21"
                  viewBox="0 0 118 21"
                  fill={`${darkMode ? `#fff` : `#22a5ad`}`}
          ...
          <div className={`logoIconMenu duration-300 p-2 rounded-full cursor-pointer hover:text-[#fff] ${darkMode  ? "hover:bg-[#5d5d5d] text-[#fff]" : "hover:bg-[#22a5ad] text-[#22a5ad]"}`}
            onClick={() => onClickLogoImagesSetting()}
          >
        ...
        <div className="flex items-center justify-between h-fit w-full px-3">
          ...
          <div className={`flex flex-wrap gap-5 p-4 rounded 
            ${darkMode ? "bg-[#1f2125] border border-[#000]" : "bg-[#ebf9fa]"}`}
          >
            <h1 className={`${darkMode ? "w-full text-white border-b pb-3 border-[#666]" : "text-[#258c91]"}`}>
              كن متبرعا شهريا
            </h1>

            <p className={` ${darkMode ? "w-full text-white border-b pb-3 border-[#666]" : "text-[#258c91] "}`}>
              تساعدنا التبرعات الشهرية على تحسين موقع Quran.com واستدامة
              العمليات حتى نركز بشكل أقل على جمع التبرعات وأكثر على إحداث
              التأثير.
            </p>

            <div className="flex items-center gap-5 ">

              <button className={`p-2 rounded cursor-pointer ${darkMode ? "bg-[#1f2125] text-white border border-[#5d5d5d]" : "bg-[#000] text-[#fff]"}`}
                dir="rtl"
              >
                تبرع شهريا
              </button>
              ...
              <Link to={``} target="_blank">
                <div className={`border-b decoration-2 p-2 ${darkMode ? "border-[#5d5d5d] text-white" : "border-[#000] text-black"}`}
                  dir="rtl"
                >
                  تعرف على المزيد
                </div>
        ...
        <div className="logoImagesSettingNav flex items-center justify-between h-fit w-full px-3">
          ...
          <nav className="w-full">
            ...
            <ul className="w-full flex flex-wrap justify-center items-center gap-4">
              ...
              <li className="w-full cursor-pointer">
                <Link to={`/`}  className={sharedClassLogo} >
                  <button className={sharedClassBtn} >
                    <span className=" cursor-pointer"> <IoHomeSharp /> </span>
                    <span className=" cursor-pointer"> الصفحة الرئيسة </span>
                  </button>
                </Link>
              </li>
              ...
              <li className="w-full cursor-pointer">
                <Link to={`/radioFm`}
                  className={sharedClassLogo}
                >
                  <button
                    className={sharedClassBtn}
                  // onClick={() => logoImagesSetting}
                  >
                    <span className=" cursor-pointer"> <IoMdRadio /> </span>
                    <span className=" cursor-pointer"> راديو القرآن </span>
                  </button>
                </Link>
              </li>
              ...
              <li className="w-full cursor-pointer">
                ...
                >
                  ...
                  // onClick={() => logoImagesSetting}
                  >
                    <span className="cursor-pointer"> <IoInformationCircle /> </span>
                    <span className="cursor-pointer"> معلومات عنا </span>
                  </button>
                </Link>
              </li>
...
export default SidebarIconLogo